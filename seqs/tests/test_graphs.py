...
class GraphsTest(TestCase):
    ...
    def test_DyckGraph(self):
        """ Check that the graph generation works."""
        # TODO actually test that it makes the correct graph.
        self.assertEqual(LCFNotation([-13, 5, -5, 13], 8), {0: (31, 1, 19),
                                                            1: (0, 2, 6),
                                                            2: (1, 3, 29),
                                                            3: (2, 4, 16),
                                                            4: (3, 5, 23),
    ...
    def test_PappusGraph(self):
        """ Check that the graph generation works."""
        # TODO actually test that it makes the correct graph.
        self.assertEqual(LCFNotation([5, 7, -7, 7, -7, -5], 3), {0: (17, 1, 5),
                                                                 1: (0, 2, 8),
                                                                 2: (1, 3, 13),
                                                                 3: (2, 4, 10),
                                                                 4: (3, 5, 15),
    ...
    def test_TutteCoxeterGraph(self):
        """ Check that the graph generation works."""
        # TODO actually test that it makes the correct graph.
        self.assertEqual(LCFNotation([-13, -9, 7, -7, 9, 13], 5), {0: (29, 1, 17),
                                                                   1: (0, 2, 22),
                                                                   2: (1, 3, 9),
                                                                   3: (2, 4, 26),
                                                                   4: (3, 5, 13),
    ...
    def test_GrayGraph(self):
        """ Check that the graph generation works."""
        # TODO actually test that it makes the correct graph.
        self.assertEqual(LCFNotation([-25, 7, -7, 13, -13, 25], 9), {0: (53, 1, 29),
                                                                     1: (0, 2, 8),
                                                                     2: (1, 3, 49),
                                                                     3: (2, 4, 16),
                                                                     4: (3, 5, 45),
