...
from typing import Iterable, SupportsIndex, Sized
from seqs.Eratosthenes import MoebiusFunction


def LengthLimitedLyndonWords(s: int, n: int):
...
def LyndonWordsWithLength(s: int, n: int):
    """
...
def DeBruijnSequence(s: int, n: int):
    """
...
def CountLyndonWords(s: int, n: int):
    """
...
def ChenFoxLyndonBreakpoints(s: [list, tuple, str]) -> int:
...
def ChenFoxLyndon(s: [list, tuple, str]) -> [SupportsIndex, Iterable, Sized]:
    """
...
def SmallestSuffix(s: [list, tuple, str]) -> int:
    """
...
def SmallestRotation(s: [list, tuple, str]):
    """
...
def isLyndonWord(s: [list, tuple, str]) -> bool:
